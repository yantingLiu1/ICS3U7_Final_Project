	...
	public static void setIntoFile(String[] array) {
		 ...
		 PatientInfoName nameTemp = new PatientInfoName(array[0], array[1]);
			...
			try{
				...
				String fileAllHealthNumbers = pathForFile + "\\AllHealthNumbers.txt";
				...
				BufferedWriter patientInfoWriterAllHealthNum = new BufferedWriter(new FileWriter(fileAllHealthNumbers)); 
				...
				patientInfoWriterAllHealthNum.write(healthNumTemp.getHealthNumber());
				...
				patientInfoWriterAllHealthNum.close();
