...
class viewf extends JFrame implements ActionListener {
	String notein;
    String[] patientInfoArray = new String[8];
    String[]  notes;
    String notesNoSpace;
    ...
    viewf() {
        ...
        try {
            ...
            add(new CustomLabel(notesNoSpace, 30, 55 * 15, 300, 450));
        }
        ...
        for (int i = 0; i < notes.length; i++) {
            add(new CustomLabel(notes[i], 30, 55 + i * 15, 300, 450));
        }
    ...
    public String[] readFiles() {
		...
		try {		
			String pathWOtxt = "storedInformation\\3";
