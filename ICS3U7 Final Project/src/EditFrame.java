...
public class EditFrame extends JDialog implements ActionListener {
    ...
    /**
     * Edit frame of the GUI 
     * @param folder name of the folder that stored the information
     */
     ...
     * @param array Array of the information
     */
    ...
    /**
     * Deletes the files
     * @param dir File directory with all the files in
     */
     ...
     * @param s String of the postal code
     * @return boolean TRUE if the Postal String is a valid Postal code
     */
    public static boolean isPostal(String s) {
    	
    	//checks if length is longer than 6
        if (s.length() != 6) {
            return false;
        }
        
        //creates a char array to split the input 
        char[] p = new char[6];
        ...
        //checks for every even letter is a letter
        for (int i = 0; i < 6; i += 2) {
        ...
        //checks for every odd letter is odd
        for (int i = 1; i < 6; i += 2) {
